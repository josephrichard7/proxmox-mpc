...
export class HelpCommand extends BaseCommand {
  ...
  async execute(args: string[], _session: ConsoleSession): Promise<void> {
    if (args.length > 0) {
      await this.showSpecificHelp(args[0], _session);
    } else {
      await this.showGeneralHelp(_session);
    }
  }
  ...
  private async showGeneralHelp(session: ConsoleSession): Promise<void> {
    ...
    console.log(
      "  /sync                 Sync infrastructure and generate IaC + tests",
    );
    console.log("  /validate             Run comprehensive validation checks");
    console.log(
      "  /test                 Validate generated IaC and run TDD tests",
    );
    ...
    console.log(
      "  /debug [on|off]       Control debug mode and verbose output",
    );
    console.log("  /health [--detailed]  Show comprehensive system health");
    console.log(
      "  /logs [options]       Query and display logs with filtering",
    );
    console.log(
      "  /report-issue <desc>  Generate diagnostic report for AI help\n",
    );

    console.log("🔐 Privacy & Data Protection:");
    console.log("  /anonymize [text]     Interactive data anonymization tool");
    console.log(
      "  /privacy              Privacy and anonymization information",
    );
    console.log(
      "  /report-issue --safe  Generate anonymized diagnostic reports\n",
    );

    console.log("🏗️  Resource Commands (Future):");
    console.log("  create vm --name <name>         Generate VM configuration");
    console.log(
      "  create container --name <name>  Generate container configuration",
    );
    ...
    if (!session.workspace) {
      ...
      console.log(
        `  Server: ${session.workspace.config.host}:${session.workspace.config.port}`,
      );
    ...
    console.log(
      "🌐 Documentation: See VISION.md and PLAN.md in the project root\n",
    );
  }

  private async showSpecificHelp(
    command: string,
    ...
    switch (command) {
      case "init":
        ...
        console.log(
          "Creates a new Proxmox infrastructure project in the current directory.",
        );
        ...
        console.log(
          "  • Create tests/ directory for infrastructure validation",
        );
      ...
      case "status":
        ...
        console.log(
          "Displays current project and server information including:",
        );
      ...
      case "test":
        ...
        console.log(
          "Comprehensive validation and testing of generated configurations:",
        );
        ...
        console.log(
          "This command ensures all configurations are valid and tested.",
        );
      ...
      case "destroy":
        ...
        console.log(
          "Destroys infrastructure resources with comprehensive safety checks:",
        );
        ...
        console.log(
          "⚠️  WARNING: This operation is IRREVERSIBLE and may cause data loss!",
        );
        console.log("Options:");
        console.log("  --dry-run, -n         Show what would be destroyed");
        console.log(
          "  --auto-approve, -y    Skip final confirmation (DANGEROUS)",
        );
        console.log(
          "  --force, -f           Override safety checks (VERY DANGEROUS)",
        );
        console.log(
          "  --no-backups          Don't preserve state file backups",
        );
        console.log(
          "  --target, -t <res>    Destroy only specific resources\n",
        );
      ...
      case "logs":
        ...
        console.log("Options:");
        console.log(
          "  -n, --limit <number>  Limit number of logs (default: 50)",
        );
        console.log(
      ...
      case "report-issue":
        ...
        console.log(
          "Generate comprehensive diagnostic reports for AI assistance:",
        );
        ...
        console.log(
          'Example: /report-issue "terraform apply failed with timeout"\n',
        );
        break;
