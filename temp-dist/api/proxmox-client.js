...
class ProxmoxClient {
    ...
    async getNodeStatus(node) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/status`);
            return this.extractData(response.data);
        }
        catch (error) {
    ...
    async getVMs(node) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/qemu`);
    ...
    async getVMStatus(node, vmid) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/qemu/${vmid}/status/current`);
    ...
    async getVMConfig(node, vmid) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/qemu/${vmid}/config`);
    ...
    async createVM(node, config) {
        try {
            ...
            const response = await this.httpClient.post(`/nodes/${node}/qemu`, requestData);
     ...
     */
    async waitForVMCreation(node, vmid, timeoutMs = 300000) {
    ...
    async startVM(node, vmid) {
        try {
            const response = await this.httpClient.post(`/nodes/${node}/qemu/${vmid}/status/start`);
            const upid = this.extractData(response.data);
     ...
     */
    async stopVM(node, vmid, force = false) {
        try {
            const requestData = force ? { forceStop: 1 } : {};
            const response = await this.httpClient.post(`/nodes/${node}/qemu/${vmid}/status/stop`, requestData);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
    ...
    async shutdownVM(node, vmid) {
        try {
            const response = await this.httpClient.post(`/nodes/${node}/qemu/${vmid}/status/shutdown`);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
    ...
    async rebootVM(node, vmid) {
        try {
            const response = await this.httpClient.post(`/nodes/${node}/qemu/${vmid}/status/reboot`);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
     ...
     * Delete a VM
     */
    async deleteVM(node, vmid, options) {
        try {
            const requestData = {
            ...
            const response = await this.httpClient.delete(`/nodes/${node}/qemu/${vmid}`, {
                data: requestData
            });
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
     ...
     */
    async waitForVMStatus(node, vmid, targetStatus, timeoutMs = 120000) {
        const startTime = Date.now();
        while (Date.now() - startTime < timeoutMs) {
            try {
                const vm = await this.getVMStatus(node, vmid);
    ...
    async getContainers(node) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/lxc`);
    ...
    async getContainerStatus(node, vmid) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/lxc/${vmid}/status/current`);
    ...
    async getContainerConfig(node, vmid) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/lxc/${vmid}/config`);
            const config = this.extractData(response.data);
            // Ensure vmid is included
            return { ...config, vmid };
        }
     ...
     */
    async createContainer(node, config) {
        try {
            // Validate required parameters
            if (!config.vmid || config.vmid <= 0) {
            ...
            const response = await this.httpClient.post(`/nodes/${node}/lxc`, requestData);
            const upid = this.extractData(response.data);
            // Get task info
            const task = await this.getTaskStatus(node, upid);
            // TODO: Re-enable database integration once repository imports are fixed
     ...
     */
    async waitForContainerCreation(node, vmid, timeoutMs = 300000) {
        const startTime = Date.now();
        while (Date.now() - startTime < timeoutMs) {
            try {
    ...
    async startContainer(node, vmid) {
        try {
            const response = await this.httpClient.post(`/nodes/${node}/lxc/${vmid}/status/start`);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
     ...
     */
    async stopContainer(node, vmid, force = false) {
        try {
            const requestData = force ? { forceStop: 1 } : {};
            const response = await this.httpClient.post(`/nodes/${node}/lxc/${vmid}/status/stop`, requestData);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
    ...
    async shutdownContainer(node, vmid) {
        try {
            const response = await this.httpClient.post(`/nodes/${node}/lxc/${vmid}/status/shutdown`);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
    ...
    async rebootContainer(node, vmid) {
        try {
            const response = await this.httpClient.post(`/nodes/${node}/lxc/${vmid}/status/reboot`);
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
        }
        catch (error) {
     ...
     * Delete a container
     */
    async deleteContainer(node, vmid, options) {
        try {
            const requestData = {
                'skip-lock': options?.skipLock ? 1 : undefined,
                force: options?.force ? 1 : undefined,
            ...
            const response = await this.httpClient.delete(`/nodes/${node}/lxc/${vmid}`, {
                data: requestData
            });
            const upid = this.extractData(response.data);
            return await this.getTaskStatus(node, upid);
     ...
     */
    async waitForContainerStatus(node, vmid, targetStatus, timeoutMs = 120000) {
        const startTime = Date.now();
        while (Date.now() - startTime < timeoutMs) {
            try {
                const container = await this.getContainerStatus(node, vmid);
    ...
    async getStoragePools() {
        try {
            const response = await this.httpClient.get('/storage');
            return this.extractData(response.data);
        }
        catch (error) {
    ...
    async getNodeStorage(node) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/storage`);
            return this.extractData(response.data);
        }
        catch (error) {
    ...
    async getStorageContent(node, storage) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/storage/${storage}/content`);
            return this.extractData(response.data);
        }
        catch (error) {
    ...
    async getTasks(node) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/tasks`);
    ...
    async getTaskStatus(node, upid) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/tasks/${upid}/status`);
    ...
    async getTaskLog(node, upid) {
        try {
            const response = await this.httpClient.get(`/nodes/${node}/tasks/${upid}/log`);
